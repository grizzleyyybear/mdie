...
cosine similarity, so it slots into any existing FAISS / cosine-threshold gallery
on an edge device.
...
4. `showcase\03_theory_and_diagrams\figures\stage2_attention_points.png`
5. `showcase\03_theory_and_diagrams\figures\stage2_occlusion_match.png`
6. `showcase\03_theory_and_diagrams\results\real_benchmarks.csv`
