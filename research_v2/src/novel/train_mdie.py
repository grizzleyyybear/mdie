...
def train_mdie(
    ...
    """The PairedModificationDataset must yield (clean, modified, id_label, mod_label)."""
    ...
    for epoch in range(start_epoch, epochs + 1):
        ...
        for step, (clean, modded, id_lbl, mod_lbl) in enumerate(train_loader, start=1):
            ...
            with autocast("cuda", dtype=ac_dtype, enabled=USE_AMP):
                out_clean = model(clean, id_lbl, mod_lbl)
                out_mod   = model(modded, id_lbl, mod_lbl)
