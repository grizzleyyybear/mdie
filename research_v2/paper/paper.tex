...
(MFR2 masks AUC $0.734$; MeGlass glasses AUC $0.824$), winning every
...
distribution. MDIE wins every comparably-trained comparison by $+0.03$ to
$+0.10$ AUC, and remains ahead even on off-niche cross-age sets (CALFW,
...
\midrule
MFR2 (real masks)    & 848   & 0.667 & \textbf{0.734} \\
MeGlass (real glasses)& 3000  & 0.726 & \textbf{0.824} \\
CALFW (cross-age)    & 6000  & 0.523 & \textbf{0.557} \\
AgeDB-30             & 6000  & 0.536 & \textbf{0.594} \\
\bottomrule
\end{tabular}
\end{table}
