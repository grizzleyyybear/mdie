...
| 3. v3 real-benchmark eval + interpretability   | `python -m src.eval.run_real_benchmarks` <br> `python scripts/attention_bone_iou.py` <br> `python scripts/inference_compat_proof.py` | `results/real_benchmarks.csv`, `figures/roc_*.png`, `figures/attention_bone_iou.png`, `results/inference_compat_proof.json` |
